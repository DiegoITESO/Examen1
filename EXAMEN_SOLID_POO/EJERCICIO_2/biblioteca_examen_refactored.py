import buscador
from repositorio_bibilioteca import repositorioBiblioteca
...
class SistemaBiblioteca:
    def __init__(self, archivo):
        self._repositorio = repositorioBiblioteca(archivo)
    ...
    def agregar_libro(self, titulo, autor, isbn):
        ...
        # Persistencia
        self._repositorio.guardar_en_archivo()
...
def main():
    ...
    print("\n=== BÚSQUEDA POR AUTOR ===")
    resultados = sistema.buscar_libro(buscador.BuscadorPorAutor(), "Garcia")
